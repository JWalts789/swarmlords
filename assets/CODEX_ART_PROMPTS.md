...
| P1 hives | 7 × hive_*.png | **hive_ants, hive_neutral, hive_wasps, hive_beetles, hive_mantids ACCEPTED** 2026-08-24/25 (engine preserves hive art aspect ratio; delivered hives draw UPRIGHT on both ends — no mirroring; reserves counter moved to the topbar) · hive_termites, hive_moths pending |
